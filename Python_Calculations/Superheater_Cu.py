...
Utiliza o método e-NUT para dimensionar um trocador de calor ar-vapor.
Geometria baseada num tubo helicoidal de seção circular entremeio duas paredes paralelas.
"""
...
de = 6.35e-3 #m, diâmetro externo do duto
L = 0.79e-3 #m, espessura da parede do duto
di = de - 2*L #m, diâmetro interno do duto
a = 12e-3 #m, distância entre centros dos dutos, passo da hélice.
